...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolDataFromFirebase = async (school) => {
            const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/SA-1/schools/${school}/Class-5.json`);
    ...
    const saveDataToDatabase = () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/SA-1/schools/${selectedSchool}/Class-5.json`, students)
            .then(() => {

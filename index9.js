...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolData = async (school) => {
            try {
                const response = await axios.get(`https://https://marksentry-1-cccad-default-rtdb.firebaseio.com/schools/${school}/Class-9.json`);
    ...
    const saveToDatabase = async () => {
        ...
        axios
            .put(`https://https://marksentry-1-cccad-default-rtdb.firebaseio.com/schools/${selectedSchool}/Class-9.json`, students)
            .then(() => {

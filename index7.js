        ...
        if (confirmation) {
            try {
                for (const student of students) {
                    ...
                    const studentDataPath = `https://marksentry-bcdd1-default-rtdb.firebaseio.com/FA-1/CLASS-7/${schoolName}/${sno}.json`;
                    ...
                    if (response.data) {
                        ...
                        await axios.post(`https://marksentry-bcdd1-default-rtdb.firebaseio.com/FA-1/CLASS-7/${schoolName}.json`, { [sno]: student });
                    }
                }

...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolData = async (school) => {
            try {
                const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-3/schools/${school}/Class-10.json`);
    ...
    const saveToDatabase = async () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-3/schools/${selectedSchool}/Class-10.json`, students)
            .then(() => {
                    ...
                    {filteredStudents.length > 0 ? (
                        <table border="1">
                            <thead>
                                ...
                                <tr>
                                    {Array(7).fill(['FA3', 'Children\'s Participation', 'Written Work', 'Speaking', 'Behaviour', 'SubTotal', 'Grade', 'SGPA']).flat().map(header => (

...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolData = async (school) => {
            try {
                const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-4/schools/${school}/Class-9.json`);
    ...
    const saveToDatabase = async () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-4/schools/${selectedSchool}/Class-9.json`, students)
            .then(() => {
    ...
    const saveToExcel = () => {
        ...
        const headers2 = [
            "", "", "", "",
            "FA4-20M", "Children's Participation", "Written Work", "Speaking", "Behaviour", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Children's Participation", "Written Work", "Speaking", "Behaviour", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Children's Participation", "Written Work", "Speaking", "Behaviour", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Children's Participation", "Written Work", "Speaking", "Behaviour", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Children's Participation", "Written Work", "Speaking", "Behaviour", "SubTotal", "Grade", "SGPA",
                ...
                <div>
                    ...
                    <table border="1">
                        <thead>
                            ...
                            <tr>
                                {Array(7).fill(['FA4-20M', 'Children\'s Participation', 'Written Work', 'Speaking', 'Behaviour', 'SubTotal', 'Grade', 'SGPA']).flat().map(header => (

...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolData = async (school) => {
            try {
                const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-2/schools/${school}/Class-9.json`);
    ...
    const saveToDatabase = async () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-2/schools/${selectedSchool}/Class-9.json`, students)
            .then(() => {

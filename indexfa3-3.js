...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolDataFromFirebase = async (school) => {
            const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-3/schools/${school}/Class-3.json`);
    ...
    const saveDataToDatabase = () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-3/schools/${selectedSchool}/Class-3.json`, students)
            .then(() => {

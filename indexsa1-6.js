...
const maxMarks = [20, 80]; // Updated to match the allowed marks for FA1-30M, SA1-70M
...
const calculateGPA = grandTotal => (grandTotal / 600 * 10).toFixed(1); // Assuming total max marks of 500 across 5 subjects
const calculatePercentage = grandTotal => ((grandTotal / 600) * 100).toFixed(1); // Assuming total max marks of 500
...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolDataFromFirebase = async (school) => {
            const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/SA-1/schools/${school}/Class-6.json`);
    ...
    const handleInputChange = (index, subject, subIndex, value) => {
        ...
        student.grandTotal = student.telugu[2] + student.hindi[2] + student.english[2] + student.mathematics[2] + student.science[2] + student.social[2];
    ...
    const handleKeyDown = (e, index, subject, subIndex) => {
        ...
        const subjectList = ['telugu', 'hindi', 'english', 'mathematics', 'science', 'social'];
    ...
    const saveDataToDatabase = () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/SA-1/schools/${selectedSchool}/Class-6.json`, students)
            .then(() => {
                ...
                <div>
                    ...
                    <table border="1">
                        <thead>
                            ...
                            <tr>
                                {["Telugu", "Hindi", "English", "Mathematics", "Sciencce", "Social"].map(subject => (

...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolDataFromFirebase = async (school) => {
            const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-4/schools/${school}/Class-5.json`);
    ...
    const saveDataToDatabase = () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-4/schools/${selectedSchool}/Class-5.json`, students)
            .then(() => {
    ...
    const saveToExcel = () => {
        ...
        const headers2 = [
            "", "", "", "",
            "FA4-20M", "Speaking", "Basic Knowledge", "Writing", "Corrections", "Behaviour", "Activity", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Speaking", "Basic Knowledge", "Writing", "Corrections", "Behaviour", "Activity", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Speaking", "Basic Knowledge", "Writing", "Corrections", "Behaviour", "Activity", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Speaking", "Basic Knowledge", "Writing", "Corrections", "Behaviour", "Activity", "SubTotal", "Grade", "SGPA",
            "FA4-20M", "Speaking", "Basic Knowledge", "Writing", "Corrections", "Behaviour", "Activity", "SubTotal", "Grade", "SGPA",

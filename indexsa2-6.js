...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolDataFromFirebase = async (school) => {
            const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/SA-2/schools/${school}/Class-6.json`);
    ...
    const saveDataToDatabase = () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/SA-2/schools/${selectedSchool}/Class-6.json`, students)
            .then(() => {

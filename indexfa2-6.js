...
function StudentMarksEntry() {
    ...
    useEffect(() => {
        const fetchSchoolData = async (school) => {
            try {
                const response = await axios.get(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-2/schools/${school}/Class-6.json`);
    ...
    const saveToDatabase = async () => {
        ...
        axios
            .put(`https://marksentry2024-default-rtdb.firebaseio.com/2024/FA-2/schools/${selectedSchool}/Class-6.json`, students)
            .then(() => {
                        ...
                        <thead>
                            ...
                            <tr>
                                {['Telugu', 'Hindi', 'English', 'Mathematics', 'Science', 'Social'].flatMap(subject =>
                                    ['FA2-20M', "Children's Participation", 'Written Work', 'Speaking', 'Behaviour', 'SubTotal', 'Grade', 'SGPA']
